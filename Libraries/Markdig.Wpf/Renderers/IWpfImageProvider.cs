...
namespace Markdig.Renderers
{
    ...
    public interface IWpfImageProvider
    {
        ...
        /// <returns>The inline text element containing the image, or anything else (e.g. a <see cref="Run"/> containing an error message.</returns>
        ...
        Inline GetInlineItem(string url);
    }
}
