...
namespace System.IO.Compression
{
  internal sealed partial class WrappedStream : Stream
  {
    ...
    private readonly Action<ZipArchiveEntryAxo> _onClosed;

    // Instance that will be passed to _onClose delegate
    private readonly ZipArchiveEntryAxo _zipArchiveEntry;
    private bool _isDisposed;

    internal WrappedStream(Stream baseStream, bool closeBaseStream)
        : this(baseStream, closeBaseStream, null, null) { }

    private WrappedStream(Stream baseStream, bool closeBaseStream, ZipArchiveEntryAxo entry, Action<ZipArchiveEntryAxo> onClosed)
    {
    ...
    internal WrappedStream(Stream baseStream, ZipArchiveEntryAxo entry, Action<ZipArchiveEntryAxo> onClosed)
  ...
  internal sealed partial class SubReadStream : Stream
  {
    ...
    public SubReadStream(Stream superStream, long startPosition, long maxLength, bool isStreamOwner = false)
    {
  ...
  internal sealed partial class CheckSumAndSizeWriteStream : Stream
  {
    ...
    private readonly Action<long, long, uint, Stream, ZipArchiveEntryAxo, EventHandler> _saveCrcAndSizes;
    ...
    public CheckSumAndSizeWriteStream(Stream baseStream, Stream baseBaseStream, bool leaveOpenOnClose,
        ZipArchiveEntryAxo entry, EventHandler onClose,
        Action<long, long, uint, Stream, ZipArchiveEntryAxo, EventHandler> saveCrcAndSizes)
    {
      _baseStream = baseStream;
