...
namespace ICSharpCode.SharpDevelop.Gui
{
  ...
  public partial class WpfWorkbench : FullScreenEnabledWindow, IWorkbench, System.Windows.Forms.IWin32Window
	{
    public string mainMenuPath = "/SharpDevelop/Workbench/MainMenu";
    public string viewContentPath = "/SharpDevelop/Workbench/Pads";
    public string toolBarPath = "/SharpDevelop/Workbench/ToolBar";
#else
