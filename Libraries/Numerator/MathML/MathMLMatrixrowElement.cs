...
namespace MathML
{
	...
	/// </summary>
	public class MathMLMatrixRowElement : MathMLContentElement
	{
		/// <summary>
		...
		public MathMLMatrixRowElement(string prefix, string localName, string namespaceURI, MathMLDocument doc)
