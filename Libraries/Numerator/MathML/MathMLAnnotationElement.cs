...
namespace MathML
{
	...
	/// </summary>
	public class MathMLAnnotationElement : MathMLElement
	{
		/// <summary>
		...
		public MathMLAnnotationElement(string prefix, string localName, string namespaceURI, MathMLDocument doc)
