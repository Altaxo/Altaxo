...
namespace MathML
{
	...
	/// </summary>
	public class MathMLLambdaElement : MathMLContentContainer
	{
		/// <summary>
		...
		public MathMLLambdaElement(string prefix, string localName, string namespaceURI, MathMLDocument doc)
