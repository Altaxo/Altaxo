...
namespace MathML
{
	...
	/// </summary>
	public class MathMLIntervalElement : MathMLContentElement
	{
		/// <summary>
		...
		public MathMLIntervalElement(string prefix, string localName, string namespaceURI, MathMLDocument doc)
