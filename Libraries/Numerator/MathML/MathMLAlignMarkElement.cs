...
namespace MathML
{
	...
	/// </summary>
	public class MathMLAlignMarkElement : MathMLPresentationElement
	{
		/// <summary>
		...
		public MathMLAlignMarkElement(string prefix, string localName, string namespaceURI, MathMLDocument doc)
