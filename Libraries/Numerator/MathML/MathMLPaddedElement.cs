...
namespace MathML
{
	...
	/// </summary>
	public class MathMLPaddedElement : MathMLPresentationContainer
	{
		/// <summary>
		...
		public MathMLPaddedElement(string prefix, string localName, string namespaceURI, MathMLDocument doc)
