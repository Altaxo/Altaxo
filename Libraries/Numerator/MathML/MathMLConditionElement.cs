...
namespace MathML
{
	...
	/// </summary>
	public class MathMLConditionElement : MathMLContentElement
	{
		/// <summary>
		...
		public MathMLConditionElement(string prefix, string localName, string namespaceURI, MathMLDocument doc)
