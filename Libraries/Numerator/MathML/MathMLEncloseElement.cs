...
namespace MathML
{
	...
	/// </summary>
	public class MathMLEncloseElement : MathMLPresentationContainer
	{
		/// <summary>
		...
		public Notation Notation
		{
			get
			{
				MathML.Notation notation;
				switch(GetAttribute("notation"))
				{
					case "radical" : notation = MathML.Notation.Radical; break;
					case "acturatial" : notation = MathML.Notation.Actuarial; break;
					default : notation = MathML.Notation.Longdiv; break;
				}
				return notation;
			}
			set
			{
				SetAttribute("notation", value.ToString().ToLower());
			}
		}
