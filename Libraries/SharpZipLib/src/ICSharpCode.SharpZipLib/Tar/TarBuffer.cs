...
namespace ICSharpCode.SharpZipLib.Tar 
{
	...
	public class TarBuffer
	{
		...
		public void SkipRecord()
		{
			if (this.debug) 
			{
				//Console.WriteLine.WriteLine("SkipRecord: recIdx = " + this.currRecIdx + " blkIdx = " + this.currBlkIdx);
			}
		...
		public byte[] ReadRecord()
		{
			if (this.debug) 
			{
				//Console.WriteLine.WriteLine( "ReadRecord: recIdx = " + this.currRecIdx + " blkIdx = " + this.currBlkIdx );
			}
		...
		bool ReadBlock()
		{
			...
			if (this.debug) 
			{
				//Console.WriteLine.WriteLine("ReadBlock: blkIdx = " + this.currBlkIdx);
			}
			...
			for (; bytesNeeded > 0 ;) 
			{
				...
				if (numBytes != this.blockSize) 
				{
					if (this.debug) 
					{
						//Console.WriteLine.WriteLine("ReadBlock: INCOMPLETE READ " + numBytes + " of " + this.blockSize + " bytes read.");
					}
				}
			}
		...
		public void WriteRecord(byte[] record)
		{
			if (this.debug) 
			{
				//Console.WriteLine.WriteLine("WriteRecord: recIdx = " + this.currRecIdx + " blkIdx = " + this.currBlkIdx );
			}
		...
		void WriteBlock()
		{
			if (this.debug) 
			{
				//Console.WriteLine.WriteLine("WriteBlock: blkIdx = " + this.currBlkIdx);
			}
