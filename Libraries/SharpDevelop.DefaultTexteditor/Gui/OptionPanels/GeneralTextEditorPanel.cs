...
namespace ICSharpCode.SharpDevelop.DefaultEditor.Gui.OptionPanels
{
	...
	{
		static Font selectedFont = new Font("Courier New", 10);
		...
		public override void LoadPanelContents()
		{
			...
			ControlDictionary["fontNameDisplayTextBox"].Text = ((IProperties)CustomizationObject).GetProperty("DefaultFont", GeneralTextEditorPanel.selectedFont).ToString();
		...
		public override bool StorePanelContents()
		{
			...
			((IProperties)CustomizationObject).SetProperty("DefaultFont",          GeneralTextEditorPanel.selectedFont);
		...
		void SelectFontEvent(object sender, EventArgs e)
		{
			using (FontDialog fdialog = new FontDialog()) {
				fdialog.Font = GeneralTextEditorPanel.selectedFont;
				if (fdialog.ShowDialog() == DialogResult.OK) {
					...
					GeneralTextEditorPanel.selectedFont  = newFont;
					((IProperties)CustomizationObject).SetProperty("DefaultFont",GeneralTextEditorPanel.selectedFont);
