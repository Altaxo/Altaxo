...
{
	public class AltaxoOpenFileTab : Crownwood.Magic.Controls.TabControl, IOwnerState
	{
		readonly static string contextMenuPath = "/SharpDevelop/Workbench/AltaxoOpenFileTab/ContextMenu";
		...
		public class MyTabPage : Crownwood.Magic.Controls.TabPage
		{
			...
			public MyTabPage(AltaxoOpenFileTab tab, IWorkbenchWindow window)
			{
				this.tab    = tab;
				this.window = window;
