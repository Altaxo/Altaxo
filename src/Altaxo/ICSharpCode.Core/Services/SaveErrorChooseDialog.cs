...
namespace ICSharpCode.Core.Services
{
	...
	public class SaveErrorChooseDialog : System.Windows.Forms.Form 
	{
		...
		private void InitializeComponents(bool chooseLocationEnabled) 
		{
			...
			this.retryButton.Size = new Size(120, 23);
			this.retryButton.Location = new Point(4, 206);
			...
			this.ignoreButton.Size = new Size(120, 23);
			this.ignoreButton.Location = new Point(132, 206);
			...
			this.descriptionLabel.Location = new Point(8, 0);
			this.descriptionLabel.Size = new Size(510, 24);
			...
			this.descriptionTextBox.Size = new Size(502, 174);
			this.descriptionTextBox.Location = new Point(8, 24);
			...
			this.exceptionButton.Size = new Size(120, 23);
			this.exceptionButton.Location = new Point(388, 206);
			...
			if (chooseLocationEnabled) {
				...
				this.chooseLocationButton.Size = new Size(120, 23);
				this.chooseLocationButton.Location = new Point(260, 206);
			}
