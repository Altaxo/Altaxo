...
namespace Altaxo.Gui.Workbench
{
	...
	public partial class ExceptionBox : Window
	{
		...
		public void InitializeText()
		{
			...
			this._guiImage.Source = Altaxo.Gui.WpfResourceService.Instance.GetBitmapSource("Altaxo.Gui.ExceptionBox.Image");
		}
		...
		private string getClipboardString()
		{
			...
			try
			{
				ICSharpCode.SharpDevelop.SD.GetRequiredService<ApplicationStateInfoService>().AppendFormatted(sb);
			}
			catch (Exception ex)
			{
