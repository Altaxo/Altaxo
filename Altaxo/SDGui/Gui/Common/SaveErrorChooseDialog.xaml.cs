...
namespace Altaxo.Gui.Common
{
	...
	public partial class SaveErrorChooseDialog : Window
	{
		...
		public SaveErrorChooseDialog()
		{
			...
			this.exceptionButton.Content = ResourceService.GetString("ICSharpCode.Core.Services.ErrorDialogs.ShowExceptionButton");
			this.chooseLocationButton.Content = ResourceService.GetString("Global.ChooseLocationButtonText");
		}
