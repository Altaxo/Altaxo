...
namespace Altaxo.Graph.Gdi
{
	...
	{
		PointF _hittedPointInPageCoord;
		double _pageScale;
		...
		public HitTestData(PointF hitPointPageCoord, double pageScale)
		{
		...
		public HitTestData(HitTestData from)
		{
		...
		/// </summary>
		public PointF HittedPointInPageCoord
		{
		...
		/// <summary>
		/// Transformation that transform world coordinates to page coordinates.
		/// </summary>
		...
		public HitTestData NewFromTranslationRotationScaleShear(double x, double y, double rotation, double scaleX, double scaleY, double shear)
		{
			var result = new HitTestData(this);
		...
		public HitTestData NewFromAdditionalTransformation(TransformationMatrix2D additionalTransformation)
		{
			var result = new HitTestData(this);
		...
		public PointF GetHittedPointInWorldCoord()
		{
		...
		/// </summary>
		/// <returns>Hitted point in world coordinates.</returns>
		public PointF GetHittedPointInWorldCoord(TransformationMatrix2D additionalTransform)
		{
