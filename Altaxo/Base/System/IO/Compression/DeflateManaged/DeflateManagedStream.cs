...
namespace System.IO.Compression
{
    internal sealed partial class DeflateManagedStream : Stream
    {
        ...
        internal DeflateManagedStream(Stream stream, ZipArchiveEntryAxo.CompressionMethodValues method)
        {
            if (stream == null)
        ...
        /// </summary>
        internal void InitializeInflater(Stream stream, bool leaveOpen, IFileFormatReader reader = null, ZipArchiveEntryAxo.CompressionMethodValues method = ZipArchiveEntryAxo.CompressionMethodValues.Deflate)
        {
            Debug.Assert(stream != null);
            Debug.Assert(method == ZipArchiveEntryAxo.CompressionMethodValues.Deflate || method == ZipArchiveEntryAxo.CompressionMethodValues.Deflate64);
            if (!stream.CanRead)
                throw new ArgumentException(SR.NotSupported_UnreadableStream, nameof(stream));

            _inflater = new InflaterManaged(reader, method == ZipArchiveEntryAxo.CompressionMethodValues.Deflate64 ? true : false);
