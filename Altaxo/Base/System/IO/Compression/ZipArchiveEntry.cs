...
namespace System.IO.Compression
{
    ...
    public partial class ZipArchiveEntryAxo
    {
        ...
        private ZipArchiveAxo _archive;
        ...
        internal ZipArchiveEntryAxo(ZipArchiveAxo archive, ZipCentralDirectoryFileHeader cd)
        {
            _archive = archive;
        ...
        internal ZipArchiveEntryAxo(ZipArchiveAxo archive, string entryName, CompressionLevel compressionLevel)
        ...
        // Initializes new entry
        internal ZipArchiveEntryAxo(ZipArchiveAxo archive, string entryName)
        {
            _archive = archive;
        ...
        private CheckSumAndSizeWriteStream GetDataCompressor(Stream backingStream, bool leaveBackingStreamOpen, EventHandler onClose)
        {
            ...
            var checkSumStream = new CheckSumAndSizeWriteStream(
                ...
                this,
                onClose,
                (long initialPosition, long currentPosition, uint checkSum, Stream backing, ZipArchiveEntryAxo thisRef, EventHandler closeHandler) =>
                {
        ...
        private Stream OpenInWriteMode()
        {
            ...
            CheckSumAndSizeWriteStream crcSizeStream = GetDataCompressor(_archive.ArchiveStream, true, (object o, EventArgs e) =>
            {
                ...
                var entry = (ZipArchiveEntryAxo)o;
                        ...
                        CompressionMethod != CompressionMethodValues.Deflate64)
                    {
                        switch (CompressionMethod)
                        {
                            ...
                            case CompressionMethodValues.LZMA:
                                message = SR.UnsupportedCompressionMethod + " " + CompressionMethod.ToString();
                                break;
                            default:
        ...
        private sealed partial class DirectToArchiveWriterStream : Stream
        {
            ...
            public DirectToArchiveWriterStream(Stream crcSizeStream, ZipArchiveEntryAxo entry, bool closeBaseStream = true)
            {
                _position = 0;
