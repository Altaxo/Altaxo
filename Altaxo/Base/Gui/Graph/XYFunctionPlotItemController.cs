...
{
  /// <summary>
  /// Summary description for XYFunctionPlotItemController.
  /// </summary>
  [UserControllerForObject(typeof(XYFunctionPlotItem))]
  public class XYFunctionPlotItemController : TabbedElementController, Main.GUI.IMVCAController, IXYPlotGroupViewEventSink
  {
    XYFunctionPlotItem _doc;
    XYFunctionPlotItem _tempdoc;
    ...
    public XYFunctionPlotItemController(XYFunctionPlotItem doc)
      : this(doc, null)
    {
    }
    public XYFunctionPlotItemController(XYFunctionPlotItem doc, PlotGroup parent)
    {
      _parentPlotGroup = parent;
      _doc = doc;
      _tempdoc = (XYFunctionPlotItem)_doc.Clone();
    ...
    public bool Apply()
    {
      ...
      {
        if (null!=Tab(i).Controller && false == Tab(i).Controller.Apply())
        {
          BringTabToFront(i);
          applyResult = false;
    ...
    {
      XYFunctionPlotItemController _parent;

      public MyPlotStyleCollectionController(XYFunctionPlotItemController parent)
