...
namespace Altaxo.CodeEditing.Renaming
{
	public interface IRenamingService
	{
		...
		/// </summary>
		/// <param name="host">The roslyn host.</param>
		...
		Task RenameSymbol(RoslynHost host, DocumentId documentId, RoslynSourceTextContainerAdapter sourceText, int caretPosition, object topLevelWindow, Action FocusOnEditor);
	}
}