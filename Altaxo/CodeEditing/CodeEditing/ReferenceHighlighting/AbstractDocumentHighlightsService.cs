...
// Originated from: Roslyn, EditorFeatures, Implementation\ReferenceHighlighting\AbstractDocumentHighlightsService.cs
...
{
  public abstract class AbstractDocumentHighlightsService : IDocumentHighlightsService
  {
    ...
    /*
		...
		{
			System.Diagnostics.Debug.WriteLine("Could not resolve: " + args.Name);
			return null;
		}
		*/
