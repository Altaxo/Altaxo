...
internal class DeferredQuickInfoContentProvider : IDeferredQuickInfoContentProvider
{
  ...
  private class SymbolGlyphDeferredContent(Microsoft.CodeAnalysis.Glyph glyph) : IDeferredQuickInfoContent
  {
    public object Create()
    {
      var image = new Image
    ...
    private Microsoft.CodeAnalysis.Glyph Glyph { get; } = glyph;
  }
