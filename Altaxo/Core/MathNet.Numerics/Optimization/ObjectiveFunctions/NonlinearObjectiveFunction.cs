...
namespace Altaxo.Calc.Optimization.ObjectiveFunctions
{
  internal class NonlinearObjectiveFunction : IObjectiveModel
  {
    ...
    private readonly Func<Vector<double>, Vector<double>, Vector<double>> _userFunction; // (p, x) => f(x; p)
    private readonly Func<Vector<double>, Vector<double>, Matrix<double>> _userDerivative; // (p, x) => df(x; p)/dp
    ...
    private Vector<double> _gradientValue; // the Gradient vector.
