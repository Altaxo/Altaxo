...
namespace Altaxo.Calc.Ode.Dopri5
{
  ...
  public class DOPCOR
  {
    ...
    private HINIT _hinit; private CDOPRI _cdopri;
    ...
    private Odouble XOLD; private Odouble HOUT;
                     ...
                     , ref int NSTEP, ref int NACCPT, ref int NREJCT)
    {
      ...
      int o_rtol = -1 + offset_rtol;
      int o_atol = -1 + offset_atol;
      int o_y1 = -1 + offset_y1;
      int o_k1 = -1 + offset_k1;
      int o_k2 = -1 + offset_k2;
      int o_k3 = -1 + offset_k3;
      int o_k4 = -1 + offset_k4;
      int o_k5 = -1 + offset_k5;
      int o_k6 = -1 + offset_k6;
      int o_ysti = -1 + offset_ysti;
