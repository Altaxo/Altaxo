...
namespace Altaxo.Calc.LinearAlgebra
{
	...
	sealed public class ComplexDoubleSymmetricLevinson : Algorithm
	{
		...
		/// </exception>
		public ComplexDoubleSymmetricLevinson(ComplexDoubleVector T)
		{
			// check parameter
			if (T == null)
			{
		...
		/// </para>
		/// </remarks>
		public static ComplexDoubleVector Solve(ComplexDoubleVector T, ComplexDoubleVector Y)
		{
		...
		/// </para>
		/// </remarks>
		public static ComplexDoubleMatrix Solve(ComplexDoubleVector T, ComplexDoubleMatrix Y)
		{
		...
		/// </para>
		/// </remarks>
		public static ComplexDoubleVector YuleWalker(ComplexDoubleVector R)
		{
		...
		/// </para>
		/// </remarks>
		public static ComplexDoubleMatrix Inverse(ComplexDoubleVector T)
		{
