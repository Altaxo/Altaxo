...
namespace Altaxo.Calc.LinearAlgebra
{
  ...
  public static class FastNonnegativeLeastSquares
  {
    ...
    /// </para>
    /// </remarks>
    public static void Execution(IROMatrix<double> XtX, IROMatrix<double> Xty, Func<int, bool> isRestrictedToPositiveValues, double? tolerance, out IMatrix x, out IMatrix w)
    {
      if (null == XtX)
    ...
    /// </para>
    /// </remarks>
    public static void Execution(IROMatrix<double> XtX, IROMatrix<double> Xty, double? tolerance, out IMatrix x, out IMatrix w)
    {
