...
\*-----------------------------------------------------------------------------*/
	...
	//
	//   *-------------------------------------------*
	//   |  Pfa235FFT<FLOAT> (void)			 |
	//   |  Pfa235FFT<FLOAT> (int n1)			 |
	//   |  Pfa235FFT<FLOAT> (int n1, int n2)		 |
	//   |  Pfa235FFT<FLOAT> (int n1, int n2, int n3)    |
	//   *-------------------------------------------*
	//
	...
	//
	//   *-----------------------------------------------*
	//   |  Pfa235FFT (const Pfa235FFT<FLOAT>& fft)		     |
	//   |  Pfa235FFT& operator = (const Pfa235FFT<FLOAT>& fft)  |
	//   *-----------------------------------------------*
	//
